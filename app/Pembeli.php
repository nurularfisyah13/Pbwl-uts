...
class Pembeli extends Koneksi {
    ...
    public function simpan()
    {
        ...
        $sql = "INSERT INTO tb_pembeli (nama_pembeli, no_telp, alamat) VALUES (:nama_pembeli, :no_telp, :alamat)";
        $stmt = $this->db->prepare($sql);
    ...
    public function update()
    {
        ...
        $sql = "UPDATE tb_pembeli SET nama_pembeli=:nama_pembeli, no_telp=:no_telp, alamat=:alamat WHERE id_pembeli=:id_pembeli";
        $stmt = $this->db->prepare($sql);
        $stmt->bindParam(":nama_pembeli", $nama_pembeli);
        $stmt->bindParam(":no_telp", $no_telp);
        $stmt->bindParam(":alamat", $alamat);
